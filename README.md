...
The docsets generated by ZealGen are licensed under whatever the original product or website owner(s) licensed the source content under. The generated content is provided for reference purposes only and is not intended for sales or any other use case.
